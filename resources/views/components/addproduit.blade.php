            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <h4 class="page-title m-0">Ajouter un produit</h4>
                        </div>
                        <!-- end col -->
                    </div>
                    <!-- end row -->
                ...
                <div class="card-body">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <form action="{{url('/addproduit')}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label>Réference</label>
                                        <input name="refproduit" type="text" class="form-control" required placeholder="Réference du produit"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Produit</label>
                                        <input name="nomproduit" type="text" class="form-control" required placeholder="Nom du produit"/>
                                    </div>
                                    <div class="form-group">
